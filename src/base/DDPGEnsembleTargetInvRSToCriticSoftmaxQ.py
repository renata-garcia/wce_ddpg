#FILE=base/DDPGEnsembleTargetInvRSToCriticSoftmaxQ.py; rm $FILE; touch $FILE; chmod 755 $FILE; nano $FILE
...
class DDPGEnsembleTargetInvRSToCriticSoftmaxQ(DDPGPSoftmaxQEnsemble):
    ...
    def __init__(self, sess, num_ensemble, dbg_weightstderror, print_cvs):
        ...
        print("class DDPGEnsembleTargetInvRSToCriticSoftmaxQ")
    ...
    def train(self, act, addrw_mounted, ep, file_name, nobs, obs, rew, reward, steps_count,
        ...
        ddpgne.train(obs, act, train_target_critic)
