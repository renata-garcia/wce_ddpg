#FILE=base/DDPGEnsembleTargetSoftmaxQ.py; rm $FILE; touch $FILE; chmod 755 $FILE; nano $FILE

import numpy as np

from base.Online_run import DDPGPlainEnsemble

class DDPGEnsembleTargetSoftmaxQ(DDPGPlainEnsemble):
    ...
    def __init__(self, sess, num_ensemble, dbg_weightstderror, print_cvs):
        ...
        print("class DDPGEnsembleTargetSoftmaxQ")
